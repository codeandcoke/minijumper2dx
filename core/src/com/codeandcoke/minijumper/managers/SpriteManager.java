...
import com.codeandcoke.minijumper.characters.items.*;
import com.codeandcoke.minijumper.MiniJumper;
import com.codeandcoke.minijumper.characters.enemies.BigStone;
import com.codeandcoke.minijumper.characters.animations.Explosion;
...
import com.codeandcoke.minijumper.screens.GameOverScreen;

import java.util.Iterator;

import static com.codeandcoke.minijumper.util.Constants.*;
import static com.codeandcoke.minijumper.util.Constants.ENEMY_HEIGHT;
...
public class SpriteManager implements InputProcessor {
    ...
    private void updateAnimations(float dt) {
        ...
        while (iterAnimations.hasNext()) {
            ...
            else if (animation instanceof com.codeandcoke.minijumper.characters.animations.Stone) {
                Enemy enemy = null;
                com.codeandcoke.minijumper.characters.animations.Stone stone = (com.codeandcoke.minijumper.characters.animations.Stone) animation;
    ...
    public boolean keyUp(int keycode) {
        ...
        if (keycode == Input.Keys.CONTROL_LEFT) {
            ...
            if (player.firing) {
                com.codeandcoke.minijumper.characters.animations.Stone stone = player.fire();
                if (stone != null)
